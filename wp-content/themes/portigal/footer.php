        ...
        <div class="row">
          <div class="col-md-4">
            <ul class="contact-info">
              ...
              <li>2311 Palmetto Ave, Suite D1<li> 
              <li>Pacifica, CA 94404<li>
              <br>
              <li>contact@portigal.com<li>
              <li>415-894-2001 (best by appointment)<li>
            </ul>
            <p class="footer-p">Get in touch and let’s explore how we might work together! Some clients start by hiring us for a daylong work session to outline our collaboration. Our consulting projects range from weekly coaching to intensive multi-month engagements. Others invite us to present or lead workshops for their internal teams. But it all begins with an initial conversation!</p>
          </div>
